...
import { DesertParams, DEFAULT_DESERT, DESERT_PRESETS, DESERT_GROUP } from '../plant/desertParams';
...
/** What kind of plant a parameter set describes. Trees use Weber–Penn; grasses and desert plants use dedicated welded meshers. */
...
export interface TreeParams {
  ...
  grass?: GrassParams;
  /** Cactus / succulent description (kind === 'desert'). */
  desert?: DesertParams;
}
...
/** Every species: trees first, then grasses, then the dedicated desert family. */
